...
namespace Orchard.Resources {
    public class Bootstrap : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineStyle("Bootstrap").SetUrl("bootstrap.min.css", "bootstrap.css").SetVersion("4.6.2").SetCdn("//cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css", "//cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css", true);
            manifest.DefineScript("Bootstrap").SetUrl("bootstrap.min.js", "bootstrap.js").SetVersion("4.6.2").SetDependencies("jQuery").SetCdn("//cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js", "//cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js", true);
